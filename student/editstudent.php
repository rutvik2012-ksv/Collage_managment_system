...
?>
      <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title"><?php echo $row['student_name'];?></h4>
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <label class="col-sm-3 col-form-label">ENR NUM</label>
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['id'];?>" name="enr_num" class="form-control"  />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="email"   value="<?php echo $row['student_email'];?>" name ="email" class="form-control" />
                      </div>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['student_name'];?>"  name="name" class="form-control"  />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['address1'];?>"  name="address1" class="form-control" />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['address2'];?>"  name="address2" class="form-control" required />
                      </div>
                    </div>
                  </div>
