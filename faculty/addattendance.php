...
<center>
        ...
        <form id="demo-form2" action="addattendancepre.php" method="post" data-parsley-validate class="form-horizontal form-label-left">
        <h2 class="card-title" class="fab fa-accusoft"> <i class="fab fa-accusoft"></i>Enter Subjet Details</h2>
