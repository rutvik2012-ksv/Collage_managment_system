...
?>
      <center>
        ...
        <form id="demo-form2" action="entermarks.php" method="post" data-parsley-validate class="form-horizontal form-label-left">
...
<!-- sem -->
<div class="form-group row">
                      <label class="col-sm-3 col-form-label">exam<span class="required">*</span></label>
                      <div class="col-md-6 col-sm-6">
                    
                        <select name="exam" class="form-control" required>
                        <option></option>
                          <option value="mid">INTERNAL EXAM</option>
                          <option value="final">EXTERNAL EXAM</option>
                          <option value="viva">VIVA/PRACTICAL EXAM</option>
                          <option value="internal">Internal assement</option>
...
<label class="col-sm-3 col-form-label">exam marks<span class="required"></span></label>
                      <div class="col-md-6 col-sm-6">
                      <input type="text"  name="marks" class="form-control" required />
                      </div>
</div>
<!-- subject --> <div class="form-group row">
<label class="col-sm-3 col-form-label">passing marks<span class="required"></span></label>
                      <div class="col-md-6 col-sm-6">
                      <input type="text"  name="pmarks" class="form-control" required />
                      </div>
</div>
...
<div class="item form-group">
  <div class="col-md-6 col-sm-6 offset-md-5">
    ...
    <button type="submit" name="next" class="btn btn-primary">Enter</button>
  </div>
</div>
